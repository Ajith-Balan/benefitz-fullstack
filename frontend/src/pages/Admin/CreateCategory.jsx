...
const CreateCategory = () => {
  ...
  const [updatedPhoto, setUpdatedPhoto] = useState(""); // For updating category
  ...
  const handleImageUpload = (e, setImageState) => {
    ...
    reader.onloadend = () => {
      setImageState(reader.result); // Update the state with base64 string
    };
  };
            ...
            {selected && (
              <div className="mt-6 bg-gray-100 p-6 rounded-lg shadow-lg w-full md:w-1/2">
                ...
                <form onSubmit={handleUpdate}>
                  ...
                  <div className="mb-4">
                    <label htmlFor="editPhoto" className="block text-gray-700 font-medium mb-2">
                      Upload Updated Photo
                    </label>
                    <input
                      type="file"
                      className="w-full"
                      onChange={(e) => handleImageUpload(e, setUpdatedPhoto)}
                    />
                  </div>
