        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="bg-teal-400 text-white relative w-80 lg:w-64 xl:w-80 h-36 bottom-12 p-3 opacity-80">
              ...
              <Link to={service.link} className="flex items-center justify-start gap-2 font-space-grotesk text-white px-4 transition-colors duration-300 border-b border-bg-white">
